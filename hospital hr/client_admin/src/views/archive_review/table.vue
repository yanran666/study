		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/archive_review/table','add') || $check_action('/archive_review/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/archive_review/table','del') || $check_action('/archive_review/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','nursing_department')" min-width="200">
					...
					<el-table-column prop="audit_status" @sort-change="$sortChange" label="审核状态"
				v-if="user_group == '管理员' || $check_field('get','audit_status')" min-width="200">
					</el-table-column>
					<el-table-column prop="review_comments" @sort-change="$sortChange" label="审核意见"
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/archive_review/table','set') || $check_action('/archive_review/view','set') || $check_action('/archive_review/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/archive_review/table','set') || $check_action('/archive_review/view','set') || $check_action('/archive_review/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/archive_review/get_list?like=0",
				url_del: "~/api/archive_review/del?",
