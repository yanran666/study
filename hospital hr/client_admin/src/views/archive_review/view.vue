	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="护士长" prop="head_nurse">
													<el-select v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','head_nurse')) || (!form['archive_review_id'] && $check_field('add','head_nurse'))" id="head_nurse" v-model="form['head_nurse']" :disabled="disabledObj['head_nurse_isDisabled']">
				...
				<el-form-item label="护士工号" prop="nurse_no">
													<el-select v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','nurse_no')) || (!form['archive_review_id'] && $check_field('add','nurse_no'))" id="nurse_no" v-model="form['nurse_no']" :disabled="disabledObj['nurse_no_isDisabled']">
				...
				<el-form-item label="护士姓名" prop="nurse_name">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','nurse_name')) || (!form['archive_review_id'] && $check_field('add','nurse_name'))" :disabled="disabledObj['nurse_name_isDisabled']"></el-input>
				...
				<el-form-item label="性别" prop="gender">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','gender')) || (!form['archive_review_id'] && $check_field('add','gender'))" :disabled="disabledObj['gender_isDisabled']"></el-input>
				...
				<el-form-item label="身份证号码" prop="id_no">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','id_no')) || (!form['archive_review_id'] && $check_field('add','id_no'))" :disabled="disabledObj['id_no_isDisabled']"></el-input>
				...
				<el-form-item label="婚姻状态" prop="marital_status">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','marital_status')) || (!form['archive_review_id'] && $check_field('add','marital_status'))" :disabled="disabledObj['marital_status_isDisabled']"></el-input>
				...
				<el-form-item label="籍贯" prop="native_place">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','native_place')) || (!form['archive_review_id'] && $check_field('add','native_place'))" :disabled="disabledObj['native_place_isDisabled']"></el-input>
				...
				<el-form-item label="生日" prop="birthday">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','birthday')) || (!form['archive_review_id'] && $check_field('add','birthday'))" :disabled="disabledObj['birthday_isDisabled']"></el-input>
				...
				<el-form-item label="民族" prop="nation">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','nation')) || (!form['archive_review_id'] && $check_field('add','nation'))" :disabled="disabledObj['nation_isDisabled']"></el-input>
				...
				<el-form-item label="政治面貌" prop="political_landscape">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','political_landscape')) || (!form['archive_review_id'] && $check_field('add','political_landscape'))" :disabled="disabledObj['political_landscape_isDisabled']"></el-input>
				...
				<el-form-item label="联系电话" prop="contact_number">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','contact_number')) || (!form['archive_review_id'] && $check_field('add','contact_number'))" :disabled="disabledObj['contact_number_isDisabled']"></el-input>
				...
				<el-form-item label="电子邮箱" prop="e_mail">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','e_mail')) || (!form['archive_review_id'] && $check_field('add','e_mail'))" :disabled="disabledObj['e_mail_isDisabled']"></el-input>
				...
				<el-form-item label="家庭住址" prop="home_address">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','home_address')) || (!form['archive_review_id'] && $check_field('add','home_address'))" :disabled="disabledObj['home_address_isDisabled']"></el-input>
				...
				<el-form-item label="家庭联系人" prop="family_contact">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','family_contact')) || (!form['archive_review_id'] && $check_field('add','family_contact'))" :disabled="disabledObj['family_contact_isDisabled']"></el-input>
				...
				<el-form-item label="联系人电话" prop="contact_phone_number">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','contact_phone_number')) || (!form['archive_review_id'] && $check_field('add','contact_phone_number'))" :disabled="disabledObj['contact_phone_number_isDisabled']"></el-input>
				...
				<el-form-item label="参加工作日期" prop="date_of_participation_in_work">
								<el-date-picker :disabled="disabledObj['date_of_participation_in_work_isDisabled']" v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','date_of_participation_in_work')) || (!form['archive_review_id'] && $check_field('add','date_of_participation_in_work'))" id="date_of_participation_in_work"
				...
				<el-form-item label="来院工作日期" prop="date_of_work_in_the_hospital">
								<el-date-picker :disabled="disabledObj['date_of_work_in_the_hospital_isDisabled']" v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','date_of_work_in_the_hospital')) || (!form['archive_review_id'] && $check_field('add','date_of_work_in_the_hospital'))" id="date_of_work_in_the_hospital"
				...
				<el-form-item label="护龄" prop="nursing_age">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','nursing_age')) || (!form['archive_review_id'] && $check_field('add','nursing_age'))" :disabled="disabledObj['nursing_age_isDisabled']"></el-input>
				...
				<el-form-item label="学历" prop="education">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','education')) || (!form['archive_review_id'] && $check_field('add','education'))" :disabled="disabledObj['education_isDisabled']"></el-input>
				...
				<el-form-item label="职称" prop="title">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','title')) || (!form['archive_review_id'] && $check_field('add','title'))" :disabled="disabledObj['title_isDisabled']"></el-input>
				...
				<el-form-item label="年龄" prop="age">
							  ...
							  v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','age')) || (!form['archive_review_id'] && $check_field('add','age'))" :disabled="disabledObj['age_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','age')">{{form['age']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','nursing_department') || $check_field('add','nursing_department') || $check_field('set','nursing_department')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="护理部" prop="nursing_department">
																		<div v-if="user_group !== '管理员'">
							{{ get_user_session_nursing_department(form['nursing_department']) }}
							<!--<el-input id="business_name" v-model="form['nursing_department']" placeholder="请输入护理部"-->
							<!--v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','nursing_department')) || (!form['archive_review_id'] && $check_field('add','nursing_department'))" :disabled="disabledObj['nursing_department_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','nursing_department')">{{form['nursing_department']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','nursing_department')) || (!form['archive_review_id'] && $check_field('add','nursing_department'))" id="nursing_department" v-model="form['nursing_department']" :disabled="disabledObj['nursing_department_isDisabled']">
								<el-option v-for="o in list_user_nursing_department" :key="o['username']" :label="o['nickname'] + '-' + o['username']"
										   :value="o['user_id']">
								</el-option>
							</el-select>
							<el-select v-else-if="$check_field('get','nursing_department')" id="nursing_department" v-model="form['nursing_department']" :disabled="true">
								<el-option v-for="o in list_user_nursing_department" :key="o['username']" :label="o['nickname'] + '-' + o['username']"
										   :value="o['user_id']">
								</el-option>
							</el-select>
						</div>
						<el-select v-else id="nursing_department" v-model="form['nursing_department']" :disabled="disabledObj['nursing_department_isDisabled']">
							<el-option v-for="o in list_user_nursing_department" :key="o['username']" :label="o['nickname'] + '-' + o['username']"
									   :value="o['user_id']">
							</el-option>
						</el-select>
				...
				<el-form-item label="审核状态" prop="audit_status">
						...
						v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','audit_status')) || (!form['archive_review_id'] && $check_field('add','audit_status'))">
					...
					<div v-else-if="$check_field('get','audit_status')">{{form['audit_status']}}</div>
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','review_comments') || $check_field('add','review_comments') || $check_field('set','review_comments')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="审核意见" prop="review_comments">
								<el-input type="textarea" id="review_comments" v-model="form['review_comments']" placeholder="请输入审核意见"
						v-if="user_group === '管理员' || (form['archive_review_id'] && $check_field('set','review_comments')) || (!form['archive_review_id'] && $check_field('add','review_comments'))" :disabled="disabledObj['review_comments_isDisabled']"></el-input>
...
<script>
	...
	export default {
		...
		data() {
			return {
				field: "archive_review_id",
				url_add: "~/api/archive_review/add?",
				url_set: "~/api/archive_review/set?",
				url_get_obj: "~/api/archive_review/get_obj?",
				url_upload: "~/api/archive_review/upload?",
				...
				form: {
								"head_nurse": 0, // 护士长
										...
										"title":  '', // 职称
										"age":  '', // 年龄
										"nursing_department": 0, // 护理部
										"audit_status":  '', // 审核状态
										"review_comments":  '', // 审核意见
											"archive_review_id": 0, // ID
				...
				disabledObj:{
								"head_nurse_isDisabled": false,
										...
										"nursing_department_isDisabled": false,
				...
				list_user_nurse_no: [],
					...
					// 用户列表
				list_user_nursing_department: [],
						// 用户组
				group_user_nursing_department: "",
								// 审核状态选项列表
				list_audit_status: ['未审核','通过审核','审核不通过'],
		...
		methods: {
			 ...
			 * 获取护理部用户列表
			 */
			async get_list_user_nursing_department() {
                // if(this.user_group !== "管理员" && this.form["nursing_department"] === 0) {
                //     this.form["nursing_department"] = this.user.user_id;
                // }
                var json = await this.$get("~/api/user/get_list?user_group=护理部");
                if(json.result && json.result.list){
                    this.list_user_nursing_department = json.result.list;
                }
                else if(json.error){
                    console.error(json.error);
                }
			 ...
			 * 获取护理部用户组
			 */
			async get_group_user_nursing_department() {
							this.form["nursing_department"] = this.user.user_id;
							var json = await this.$get("~/api/user_group/get_obj?name=护理部");
				if(json.result && json.result.obj){
					this.group_user_nursing_department = json.result.obj;
				}
				else if(json.error){
					console.error(json.error);
				}
			},
			get_user_session_nursing_department(id){
				var _this = this;
				var user_id = {"user_id":id}
				var url = "~/api/"+_this.group_user_nursing_department.source_table+"/get_obj?"
				this.$get(url, user_id, function(res) {
					if (res.result && res.result.obj) {
						...
						var arrForm = []
							...
							arrForm.push(key)
												...
												_this.form["nursing_department"] = id
									_this.disabledObj['nursing_department' + '_isDisabled'] = true
						for (var i=0;i<arr.length;i++){
						  if (arr[i]!=='examine_state' && arr[i]!=='examine_reply') {
							for (var j = 0; j < arrForm.length; j++) {
							  if (arr[i] === arrForm[j]) {
								if (arr[i] !== "nursing_department") {
					...
					get_user_nursing_department(id){
				var obj = this.list_user_nursing_department.getObj({"user_id":id});
				var ret = "";
				if(obj){
					if(obj.nickname){
						ret = obj.nickname;}
          ...
          this.form["date_of_work_in_the_hospital"] = null;
			...
			is_view(){
				...
				if(!bl){
					bl = this.$check_action('/archive_review/table','add');
					console.log(bl ? "你有表格添加权限视作有添加权限" : "你没有表格添加权限");
				}
				if(!bl){
					bl = this.$check_action('/archive_review/table','set');
					console.log(bl ? "你有表格添加权限视作有修改权限" : "你没有表格修改权限");
				}
				if(!bl){
					bl = this.$check_action('/archive_review/view','add');
					console.log(bl ? "你有视图添加权限视作有添加权限" : "你没有视图添加权限");
				}
				if(!bl){
					bl = this.$check_action('/archive_review/view','set');
					console.log(bl ? "你有视图修改权限视作有修改权限" : "你没有视图修改权限");
				}
				if(!bl){
					bl = this.$check_action('/archive_review/view','get');
		...
		created() {
					this.get_list_user_head_nurse();
								this.get_list_user_nurse_no();
																																														this.get_list_user_nursing_department();
					this.get_group_user_nursing_department();
									},
	}
</script>
