	...
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="科室类型">
									<el-select v-model="query.department_type">
				                            <el-option v-for="o in list_department_type" :key="o" :label="o"
                            	:value="o">
                            </el-option>
										</el-select>
								</el-form-item>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column type="selection" tooltip-effect="dark" width="55">
				...
				<el-table-column prop="department_name" @sort-change="$sortChange" label="科室名称"
				v-if="user_group == '管理员' || $check_field('get','department_name')" min-width="200">
					</el-table-column>
					<el-table-column prop="department_type" @sort-change="$sortChange" label="科室类型"
				...
				v-if="user_group == '管理员' || $check_field('get','contact_number')" min-width="200">
					...
					<el-table-column prop="number_of_nurses" @sort-change="$sortChange" label="护士人数"
				v-if="user_group == '管理员' || $check_field('get','number_of_nurses')" min-width="200">
					</el-table-column>
					<el-table-column prop="operating_duty" @sort-change="$sortChange" label="工作职责"
				v-if="user_group == '管理员' || $check_field('get','operating_duty')" min-width="200">
					</el-table-column>
			...
			<el-table-column label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/department_ward/table','set') || $check_action('/department_ward/view','set') || $check_action('/department_ward/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/department_ward/table','set') || $check_action('/department_ward/view','set') || $check_action('/department_ward/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/department_ward/get_list?like=0",
				url_del: "~/api/department_ward/del?",
        ...
        try {
          ...
          return false;
			...
			export_db(tableid){
				...
				// this.$get("~/api/department_ward/export_db?",query,(json)=>{
				// 	if(json.result){
