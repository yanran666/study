	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="病区护士长" prop="ward_head_nurse">
													<el-select v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','ward_head_nurse')) || (!form['nursing_department_approval_id'] && $check_field('add','ward_head_nurse'))" id="ward_head_nurse" v-model="form['ward_head_nurse']" :disabled="disabledObj['ward_head_nurse_isDisabled']">
				...
				<el-form-item label="请假人工号" prop="leave_labor_number">
							  ...
							  v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','leave_labor_number')) || (!form['nursing_department_approval_id'] && $check_field('add','leave_labor_number'))" :disabled="disabledObj['leave_labor_number_isDisabled']"></el-input>
				...
				<el-form-item label="请假人姓名" prop="please_provide_the_dummys_name">
							  ...
							  v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','please_provide_the_dummys_name')) || (!form['nursing_department_approval_id'] && $check_field('add','please_provide_the_dummys_name'))" :disabled="disabledObj['please_provide_the_dummys_name_isDisabled']"></el-input>
				...
				<el-form-item label="病区" prop="inpatient_area">
							  ...
							  v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','inpatient_area')) || (!form['nursing_department_approval_id'] && $check_field('add','inpatient_area'))" :disabled="disabledObj['inpatient_area_isDisabled']"></el-input>
				...
				<el-form-item label="休假原因" prop="reason_for_vacation">
							  ...
							  v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','reason_for_vacation')) || (!form['nursing_department_approval_id'] && $check_field('add','reason_for_vacation'))" :disabled="disabledObj['reason_for_vacation_isDisabled']"></el-input>
				...
				<el-form-item label="申请资料" prop="application_materials">
					...
					<div v-else>
						<el-upload v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','application_materials')) || (!form['nursing_department_approval_id'] && $check_field('add','application_materials'))" class="upload-demo" drag
				...
				<el-form-item label="授权人" prop="authorized_person">
							  ...
							  v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','authorized_person')) || (!form['nursing_department_approval_id'] && $check_field('add','authorized_person'))" :disabled="disabledObj['authorized_person_isDisabled']"></el-input>
				...
				<el-form-item label="休假起止日期" prop="starting_and_ending_dates_of_vacation">
							  ...
							  v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','starting_and_ending_dates_of_vacation')) || (!form['nursing_department_approval_id'] && $check_field('add','starting_and_ending_dates_of_vacation'))" :disabled="disabledObj['starting_and_ending_dates_of_vacation_isDisabled']"></el-input>
				...
				<el-form-item label="大科护士长" prop="chief_nurse_of_major_department">
													<el-select v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','chief_nurse_of_major_department')) || (!form['nursing_department_approval_id'] && $check_field('add','chief_nurse_of_major_department'))" id="chief_nurse_of_major_department" v-model="form['chief_nurse_of_major_department']" :disabled="disabledObj['chief_nurse_of_major_department_isDisabled']">
				...
				<el-form-item label="大科批准日期" prop="date_of_approval_by_dake">
								<el-date-picker :disabled="disabledObj['date_of_approval_by_dake_isDisabled']" v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','date_of_approval_by_dake')) || (!form['nursing_department_approval_id'] && $check_field('add','date_of_approval_by_dake'))" id="date_of_approval_by_dake"
				...
				<el-form-item label="护理部" prop="nursing_department">
							...
							<!--v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','nursing_department')) || (!form['nursing_department_approval_id'] && $check_field('add','nursing_department'))" :disabled="disabledObj['nursing_department_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','nursing_department')">{{form['nursing_department']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','nursing_department')) || (!form['nursing_department_approval_id'] && $check_field('add','nursing_department'))" id="nursing_department" v-model="form['nursing_department']" :disabled="disabledObj['nursing_department_isDisabled']">
						...
						<el-select v-else id="nursing_department" v-model="form['nursing_department']" :disabled="disabledObj['nursing_department_isDisabled']">
							<el-option v-for="o in list_user_nursing_department" :key="o['username']" :label="o['nickname'] + '-' + o['username']"
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','approval_date_of_nursing_department') || $check_field('add','approval_date_of_nursing_department') || $check_field('set','approval_date_of_nursing_department')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="护理部批准日期" prop="approval_date_of_nursing_department">
								<el-date-picker :disabled="disabledObj['approval_date_of_nursing_department_isDisabled']" v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','approval_date_of_nursing_department')) || (!form['nursing_department_approval_id'] && $check_field('add','approval_date_of_nursing_department'))" id="approval_date_of_nursing_department"
						v-model="form['approval_date_of_nursing_department']" type="date" placeholder="选择日期">
					</el-date-picker>
					<div v-else-if="$check_field('get','approval_date_of_nursing_department')">{{form['approval_date_of_nursing_department']}}</div>
							</el-form-item>
			</el-col>
				...
				<el-form-item label="审批状态" prop="approval_status">
						...
						v-if="user_group === '管理员' || (form['nursing_department_approval_id'] && $check_field('set','approval_status')) || (!form['nursing_department_approval_id'] && $check_field('add','approval_status'))">
...
<script>
	...
	export default {
		...
		data() {
			return {
				field: "nursing_department_approval_id",
				url_add: "~/api/nursing_department_approval/add?",
				url_set: "~/api/nursing_department_approval/set?",
				url_get_obj: "~/api/nursing_department_approval/get_obj?",
				url_upload: "~/api/nursing_department_approval/upload?",

				query: {
					"nursing_department_approval_id": 0,
				},
				...
				form: {
								"ward_head_nurse": 0, // 病区护士长
										...
										"approval_date_of_nursing_department":  '', // 护理部批准日期
										"approval_status":  '', // 审批状态
											"nursing_department_approval_id": 0, // ID
				...
				disabledObj:{
								"ward_head_nurse_isDisabled": false,
										...
										"approval_date_of_nursing_department_isDisabled": false,
		...
		methods: {
          ...
          this.form["date_of_approval_by_dake"] = this.$toTime(parseInt(this.form["date_of_approval_by_dake"]),"yyyy-MM-dd")
					        ...
					        if (this.form["approval_date_of_nursing_department"].indexOf("-")===-1){
          this.form["approval_date_of_nursing_department"] = this.$toTime(parseInt(this.form["approval_date_of_nursing_department"]),"yyyy-MM-dd")
        }
							$.db.del("form");
				return param;
			},
          ...
          this.form["date_of_approval_by_dake"] = null;
				...
				if(parseInt(this.form["date_of_approval_by_dake"]) > 9999){
					this.form["date_of_approval_by_dake"] = this.$toTime(parseInt(this.form["date_of_approval_by_dake"]),"yyyy-MM-dd")
							        ...
							        if(this.form["approval_date_of_nursing_department"]=="0000-00-00"){
          this.form["approval_date_of_nursing_department"] = null;
        }
				if(parseInt(this.form["approval_date_of_nursing_department"]) > 9999){
					this.form["approval_date_of_nursing_department"] = this.$toTime(parseInt(this.form["approval_date_of_nursing_department"]),"yyyy-MM-dd")
				}
			...
			is_view(){
				...
				if(!bl){
					bl = this.$check_action('/nursing_department_approval/table','add');
					console.log(bl ? "你有表格添加权限视作有添加权限" : "你没有表格添加权限");
				}
				if(!bl){
					bl = this.$check_action('/nursing_department_approval/table','set');
					console.log(bl ? "你有表格添加权限视作有修改权限" : "你没有表格修改权限");
				}
				if(!bl){
					bl = this.$check_action('/nursing_department_approval/view','add');
					console.log(bl ? "你有视图添加权限视作有添加权限" : "你没有视图添加权限");
				}
				if(!bl){
					bl = this.$check_action('/nursing_department_approval/view','set');
					console.log(bl ? "你有视图修改权限视作有修改权限" : "你没有视图修改权限");
				}
				if(!bl){
					bl = this.$check_action('/nursing_department_approval/view','get');
